...
require (
	buf.build/gen/go/parca-dev/parca/connectrpc/go v1.19.0-20250716091922-79400b5144e4.1 // @grafana/observability-traces-and-profiling
	...
	connectrpc.com/connect v1.19.0 // @grafana/observability-traces-and-profiling
